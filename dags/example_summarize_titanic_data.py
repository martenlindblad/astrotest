...
default_args={
    "owner": "marten.lindblad@egmont.se,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-10-17", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "marten.lindblad@egmont.se": "mailto:marten.lindblad@egmont.se",
        "Open in Cloud IDE": "https://cloud.astronomer.io/cm2aeaupx104w01oqwnyklcnw/cloud-ide/cm2d8mtgz0ebm01mgzq4vbksl/cm2d8mtq10ec101n3przk0wty",
    },
)
